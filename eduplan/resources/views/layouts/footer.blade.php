                    ...
                    <div class="footer-widget widget widget_subscribe">
                        <div class="subscibe-wrapper">
                            <div class="content-wrap">
                                <div class="icon">
                                    <img src="{{ asset('assets/img/icon/newslater.png') }}" alt="">
                                </div>
                                <div class="content">
                            ...
                            <div class="subscribe-form">
                                <div class="form-group">
                                    <input type="text" name="fname" placeholder="Enter your Email..." class="form-control" required="" aria-required="true">
                                    <div class="btn-wrap">
                                        <a href="service-single.html" class="subscribe-btn">
                                            <img src="{{ asset('assets/img/icon/bell.png') }}" alt="">subscribe
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="footer-widget widget widget_nav_menu">
                            ...
                            <ul class="contact_info_list">
                                <li class="single-info-item">
                                    <div class="icon">
                                        <img src="{{ asset('assets/img/icon/location-02.png') }}" alt="">
                                    </div>
                                    <div class="details">
                                        Techdoodles,New Airport Road,Viman Nagar,Pune-411014
                                    </div>
                                </li>
                                <li class="single-info-item">
                                    <div class="icon me-4">
                                        <img src="{{ asset('assets/img/icon/edu-award.png') }}" alt="">
                                    </div>
                                    <div class="icon">
                                        <img src="{{ asset('assets/img/icon/iso.png') }}" alt="">
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-area-inner">
                        <p>© 2022 Eduplan. All rights reserved | Developed By <span>Vikrant Bhagat</span></p>
